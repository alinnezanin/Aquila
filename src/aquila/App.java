...
public class App {
    ...
    private static void parametros(String[] par) {
        ...
        for (String s : par) {
            if (s.contains("-i")) {
                contexto.setArqEntrada(s.substring(2));
            }
            if (s.contains("-o")) {
                contexto.setArqSaida(s.substring(2));
            }
            if (s.contains("cb")) {
                contexto.setGerarBib(true);
            }
        }
    }
}
